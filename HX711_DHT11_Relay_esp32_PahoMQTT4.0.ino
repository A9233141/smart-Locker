...
#define CALIBRATION_FACTOR 481.322
HX711 scale;
int Weight;
...
#define LINE_TOKEN  "EgAFKSe9qRveL5VDc8yPZAKcCcyNGH4BgbLIyeRQGlD"
...
float humLimit = 60;    // 濕度警示上限值
float tempLimit = 30;  // 溫度警示上限值
float weight = 100;     //重量警示上限值
